...
set(MSG_I_FLAGS "-Itraj_utils:/home/xingxun/uav_control/src/ego_planner/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg")
...
add_custom_target(_traj_utils_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "traj_utils" "/home/xingxun/uav_control/src/ego_planner/msg/Bspline.msg" "geometry_msgs/Point"
)

get_filename_component(_filename "/home/xingxun/uav_control/src/ego_planner/msg/DataDisp.msg" NAME_WE)
add_custom_target(_traj_utils_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "traj_utils" "/home/xingxun/uav_control/src/ego_planner/msg/DataDisp.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/xingxun/uav_control/src/ego_planner/msg/MultiBsplines.msg" NAME_WE)
add_custom_target(_traj_utils_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "traj_utils" "/home/xingxun/uav_control/src/ego_planner/msg/MultiBsplines.msg" "traj_utils/Bspline:geometry_msgs/Point"
)
